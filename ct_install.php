				...
				<div class="container">
					...
					<div class="cti-inner">
						...
						<div id="cleanto-installer">
							...
							<h4>Installer<div class="pull-right">Version 1.0</div></h4>
							<img src="assets/images/logo1.jpg" height="100%" width="180">
							<div class="col-md-12 col-sm-12 col-lg-12 np total_text">
								...
								<div class="text_changed"> 
									...
									<div id="cti-content" class="col-md-8 col-sm-8 col-lg-8">
										...
										<img src="assets/images/logo1.jpg" height="20%" width="20%">
